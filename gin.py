...
class GinHand:
    ...
    def deadwood_count(self):
        ...
        # recursion. add result to early_deadwood count
        explored_case = self._examine_melds(specimen) + sum(card.rank for card in early_deadwood)

        return min(worst_case, explored_case)

    # our recursive call
    def _examine_melds(self, cards):
        return 100
