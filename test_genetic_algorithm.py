...
class TestPopulation(unittest.TestCase):
    ...
    def test_ranking_func(self):
        gene_item = {'game_wins': 4, 'coinflip_game_wins': 4, 'game_losses': 0, 'generation': 0, 'game_points': 40}
        self.assertEqual(-2500, self.p.ranking_func(gene_item))

        gene_item = {'game_wins': 4, 'coinflip_game_wins': 0, 'game_losses': 0, 'generation': 0, 'game_points': 40}
        self.assertEqual(1000, self.p.ranking_func(gene_item))

        gene_item = {'game_wins': 4, 'coinflip_game_wins': 2, 'game_losses': 0, 'generation': 0, 'game_points': 40}
        self.assertEqual(2000, self.p.ranking_func(gene_item))

        gene_item = {'game_wins': 4, 'coinflip_game_wins': 2, 'game_losses': 0, 'generation': 0, 'game_points': 80}
        self.p.current_generation = 1
        self.assertEqual(4000, self.p.ranking_func(gene_item))
